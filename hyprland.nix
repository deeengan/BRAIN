  ...
  wayland.windowManager.hyprland = {
    ...
    settings = {
      ...
      bind = [
        ...
        "$mainMod SHIFT, f, movetoworkspacesilent, 4"
        "$mainMod SHIFT, r, movetoworkspacesilent, 5"
        "$mainMod SHIFT, z, movetoworkspacesilent, 6"
        "$mainMod SHIFT, p, movetoworkspacesilent, 7"
        "$mainMod SHIFT, s, movetoworkspacesilent, 8"
        "$mainMod SHIFT, x, movetoworkspacesilent, 9"
        "$mainMod SHIFT, b, movetoworkspacesilent, 10"
